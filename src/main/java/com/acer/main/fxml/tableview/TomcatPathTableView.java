...
public class TomcatPathTableView implements ViewAction {
    ...
    public <T> TomcatPathTableView(TableView<T> tableView, T item, ItemListener itemListener) {
    ...
    private void setTomcatPathColumn() {
        ...
        tableView.setRowFactory(tv -> {
            ...
            row.setOnMouseClicked(event ->  itemListener.callback(event, row));
